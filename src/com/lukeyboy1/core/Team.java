...
import com.lukeyboy1.utility.exceptions.TacticsException;
 ...
 *
 */
public class Team extends com.lukeyboy1.utility.Team {
    ...
    public String lineupString() {
        ...
        for (Player currentPlayer:players) {
            sb.append(currentPlayer.getShirtNo() + " " + currentPlayer + " " + skilledLineup.get(currentPlayer) + " " + 
                    playerLayout.get(currentPlayer)+" <br />");
        }
